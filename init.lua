local units = {
  ...
  {title="Gain",moduleName="gain",keywords="amplification"},
  {title="Gate",moduleName="gate",keywords="amplification"},
  {title="Gate Soft",moduleName="gate_soft",keywords="amplification"},
  {title="Parabolic",moduleName="parabolic",keywords="math"},
